...
<body>
	<?php
		...
		$menu->cargarEnlace('fotografia.php','Fotograf&iacute;a','menu','selected');
		...
		$articulo->getByCategory(3); // Dependiendo del tipo de categoria mostraremos unos articulos u otros
