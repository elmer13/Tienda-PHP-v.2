...
<body>
	<?php
		...
		$menu->cargarEnlace('informatica.php','Inform&aacute;tica','menu','selected');
		$menu->cargarEnlace('telefonia.php','Telefon&iacute;a','menu','');
		...
		$articulo->getByCategory(1); // Dependiendo del tipo de categoria mostraremos unos articulos u otros
