...
<body>
	<?php
		...
		$menu->cargarEnlace('videojuegos.php','Videojuegos','menu','selected');
		...
		$articulo->getByCategory(4); // Dependiendo del tipo de categoria mostraremos unos articulos u otros
